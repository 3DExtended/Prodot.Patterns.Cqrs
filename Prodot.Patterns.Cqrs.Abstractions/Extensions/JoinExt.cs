...
public static class JoinExt
{
    ...
    /// </exception>
    public static Option<TC> Join<TA, TB, TC, TKey>(
        this Option<TA> firstOption,
        Option<TB> secondOption,
        Func<TA, TKey> firstKeySelector,
        Func<TB, TKey> secondKeySelector,
        ...
        return firstOption.Match(
            ...
            some: a =>
                secondOption.Match(
                    ...
                    some: b =>
                        Option
                            .From(firstKeySelector(a))
                            .Match(
                                none: () => Option<TC>.None,
                                some: keyA =>
                                    Option
                                        .From(secondKeySelector(b))
                                        .Match(
                                            none: () => Option<TC>.None,
                                            some: keyB =>
                                            {
